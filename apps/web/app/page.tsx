...
const MtnLogo = () => (
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="50" y="58" fontFamily="var(--font-display), system-ui" fontSize="24" fontWeight="800" fill="#000" textAnchor="middle">MTN</text>
  </svg>
);
...
const AirtelTigoLogo = () => (
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <rect width="100" height="100" rx="20" fill="#1e293b" stroke="#ffffff22" strokeWidth="2" />
    <text x="50" y="55" fontFamily="var(--font-display), system-ui" fontSize="17" fontWeight="800" textAnchor="middle">
    ...
    <main ref={main}>
      ...
      <section className="hero">
        <div className="hero-bg">
          <Image src="/hero-bg.png" alt="" fill priority sizes="100vw" style={{ objectFit: "cover" }} />
        </div>
        ...
        <div className="container hero-inner">
          ...
          <div className="hero-copy">
            <div className="hero-badge">
              ...
              Instant delivery across Ghana
            </div>

            <h1 className="hero-title">
              Data you can <span className="accent">count&nbsp;on</span>, instantly.
            </h1>

            <p className="hero-desc">
              Get MTN, Telecel, and AirtelTigo bundles at the best prices. No account needed, just enter your number and pay with MoMo.
            </p>

            <div className="hero-cta-row">
              <Link href="#how-it-works" className="btn btn-ghost btn-lg">How it works</Link>
              <Link href="/buy" className="btn btn-primary btn-lg">Buy Data Now</Link>
            </div>
          ...
          <div className="widget-wrap">
            <div className="widget">
              ...
              <div className="field-group">
                ...
                <div className="net-grid">
                  {NETWORKS.map((n) => (
                    ...
                    >
                      <div className="net-icon"><n.Logo /></div>
                      <span>{n.name}</span>
                    </div>
                  ))}
                </div>
              ...
              <div className="widget-footer">
                <LockIcon />
                <span>Secure payment via Paystack MoMo</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="how-it-works" className="features">
        <div className="container">
          ...
          <div className="steps-grid">
            {[
              { n: "1", title: "Pick your bundle", desc: "Choose your network above and browse affordable data packages tailored to your needs." },
              { n: "2", title: "Confirm details", desc: "Double-check the phone number and package  we'll show you an instant price summary." },
              { n: "3", title: "Pay with MoMo", desc: "Complete payment via Mobile Money. Your data is credited within seconds, every time." },
            ].map((s) => (
              <div key={s.n} className="step-card" onMouseMove={handleCardMouse}>
      ...
      <section className="showcase">
        <div className="container showcase-inner">
          ...
          <div className="showcase-copy reveal">
            ...
            <p>
              No cluttered menus, no confusing forms. Better Data is designed so anyone from students to business owners can top up in under 30 seconds.
            </p>
      ...
      <section className="container">
        <div className="cta-banner reveal">
          ...
          <p>Get discounted rates on every bundle and earn commissions selling data to your community.</p>
          <Link href="/agents/apply" className="btn btn-primary btn-lg">Apply Now</Link>
        </div>
      </section>
        ...
        <div className="container">
          <div className="footer-grid">
            <div className="footer-brand">
              ...
              <p>The fastest way to buy data bundles in Ghana. No hidden fees, instant delivery.</p>
            </div>
            ...
            <div className="footer-col">
              ...
              <a href="https://wa.me/233000000000" className="footer-link" target="_blank" rel="noopener noreferrer">WhatsApp</a>
            </div>
            <div className="footer-col">
              ...
              <Link href="/legal#cookies" className="footer-link">Cookie Notice</Link>
            </div>
          </div>
